...
import type { RawGraph, RawCallEdge, ImportEdge } from '../../src/graph/types';

describe('buildGraphData', () => {
  it('should convert raw graph to GraphData with correct node kinds', () => {
    const raw: RawGraph = {
      functions: [
        { name: 'foo', file: 'src/a.ts', line_start: 1, line_end: 5, params: '(x: number)', returnType: 'void', kind: 'Function', className: '', qualified: 'src/a.ts::foo' },
      ],
      classes: [
        { name: 'Bar', file: 'src/a.ts', line_start: 10, line_end: 20, extends: '', implements: '', qualified: 'src/a.ts::Bar' },
      ],
      interfaces: [], enums: [], tests: [],
  ...
  it('should include CALLS edges in output', () => {
    const raw: RawGraph = {
      functions: [
        { name: 'caller', file: 'src/a.ts', line_start: 1, line_end: 5, params: '()', returnType: '', kind: 'Function', className: '', qualified: 'src/a.ts::caller' },
        { name: 'callee', file: 'src/b.ts', line_start: 1, line_end: 5, params: '()', returnType: '', kind: 'Function', className: '', qualified: 'src/b.ts::callee' },
      ],
  ...
  it('should include derived edges (INHERITS, CONTAINS, etc)', () => {
    const raw: RawGraph = {
      ...
      classes: [
        { name: 'Admin', file: 'src/a.ts', line_start: 10, line_end: 30, extends: 'User', implements: '', qualified: 'src/a.ts::Admin' },
      ],
      interfaces: [], enums: [], tests: [],
      imports: [], reExports: [], diMaps: new Map(),
    };
